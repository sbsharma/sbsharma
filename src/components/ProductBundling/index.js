      ...
      <div className="home-class">
        ...
        >
          <MainGrid
            ...
            para={
              <>
                Give your customers the best possible reasons to continue
                <br /> adding items to their baskets as they shop.
              </>
            }
            btnText={"Learn more"}
            ...
            gridHeading={
              <>
                <span style={{ color: "#F9A802" }}>
                  Conversation that drives
                </span>{" "}
                with our referal software
              </>
            }
            gridImg1="/qq.png"
            gridImg2="/rr.png"
            gridImg3="/tt.png"
            gridPara1={<>Custom product bundles</>}
