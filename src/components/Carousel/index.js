...
export default function Carousel() {
  useEffect(() => {
    ...
    $owl.children().each(function (index) {
      window.$(this).attr("data-position", index); // NB: .attr() instead of .data()
    });
    ...
    window.$(document).on("click", ".owl-item>div", function () {
      // see https://owlcarousel2.github.io/OwlCarousel2/docs/api-events.html#to-owl-carousel
      var $speed = 300; // in ms
      $owl.trigger("to.owl.carousel", [window.$(this).data("position"), $speed]);
    });
  }, []);
